// Lab1_task3.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
int main(int argc, char* argv[])
{
    ...
    if (!(is_digit(argv[2])) || !(is_digit(argv[3])) || !(is_digit(argv[4])))
    {
        return 1;
    }
